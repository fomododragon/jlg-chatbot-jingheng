...
function App() {
  ...
  const descriptions = {
    ...
    CarparkCharges: "The carpark charges are as follows: Mondays to Fridays: 5am to 8.30pm (Free Parking) 8.30am to 12 pm ($0.60/30 mins) 12pm to 2pm (Free Parking) 2pm to 5am ($0.60/30 mins) Saturdays, Sundays, and Public Holidays: 8.30am to 5am ($0.60/30 mins)",
    CarparkLots: "North Carpark: Total Parking Lots: 175 Handicap Lots: 2 Motorcycle Lots: 15 South Carpark: Total Parking Lots: 175 Handicap Lots: 4 Motorcycle Lots: 11 Bus Bay: 5",
    CarparkAccessibility: "Drivers with mobility impairment (Class 1 Label) Passengers with mobility impairment (Class 2 Label) (After which, the driver has to move the vehicle to a standard parking lot) **A mobility impairment is a disability that affects movement ranging from gross motor skills, such as walking, to fine motor movement, involving manipulation of objects by hand.",
    ...
    GeneralEvents: "The Gardens do host events such as Bazaar in the Garden and Mid-Autumn Festival etc. For more details, please head over to https://www.nparks.gov.sg/juronglakegardens/whats-happening/calendar-of-events",
    ...
    ActivitiesPicnic: "Yes, a simple mat is allowed in the Gardens. However, no set ups of tables, chairs and likes are allowed. Visitors will be required to clean up after the picnic. One can set up a picnic at designated lawns and grass areas. Designated lawns: The Oval, Butterfly Field, Lakeside Field. NO picnic is allowed at Grasslands.",
    ...
    ActivitiesCycling: "Cycling is allowed on the main path of Lakeside Garden in Jurong Lake Gardens. However, for the safety of all visitors, we request that all cyclists give way to pedestrians, and keep left when on a shared track. Do note that cycling is not allowed at certain locations like the Grasslands, Rasau Walk, ABC Waters at Jurong Lake, and areas with ‘Dismount and Push’ signs.",
    ActivitiesSkating: "Skating/Kick scooter is allowed on the main path at the Gardens. However, do skate and kick scooter at a safe speed to prevent accidents on the shared track. Skating is not allowed on Rasau Walk as it is a meandering boardwalk along the water’s edge.	",
    ActivitiesRollerblading: "Rollerblading is allowed on the main path at the Gardens. However, do rollerblade at a safe speed to prevent accidents on the shared track. Rollerblading is not allowed on Rasau Walk as it is a meandering boardwalk along the water’s edge.",
    ...
    ActivitiesCamping: "Camping or use of tents is not permitted in Jurong Lake Gardens. You may camp at designated camping sites such as East Coast Park, Pasir Ris Park, West Coast Park and Pulau Ubin, subject to the current COVID-19 advisories. For more information on camping at our parks and gardens, you may refer to the website: https://www.nparks.gov.sg/activities/fun-and-recreation/camping ",
    ...
    FnBLocation: "There is currently one food establishment in the Gardens – Fusion Spoon. Monday to Friday: 10 am to 10 pm Saturday and Sunday: 7 am to 10 pm",
    FnBVending: "Vending machines can be found at ActiveSG Park, Gardenhouse, Play Pavilion and Clusia Cove Pavilion. Vending machines dispensing hot food can be found at Gardenhouse and Forest Ramble",
    FnBHalal: "Fusion Spoon, located in Lakeside Garden, is open daily, from 10.00am to 10.00pm on Monday - Friday, and from 7.00am to 10.00pm on Saturday and Sunday (Subject to prevailing COVID-19 Safe Management Measures). It is halal certified. In addition, there are vending machines selling light snacks and drinks at the Entrance Pavilion, Clusia Cove, Play Pavilion, Gardenhouse, ActiveSGPark and PAssion WaVe.",
    FacilitiesToilets: "Toilets are located at Fusion Spoon, Clusia Cove Pavilion, PAssion WaVe, Play Pavilion, Gardenhouse and ActiveSG Park. Handicapped toilets can be found at ActiveSG Park, Gardenhouse, Clusia Cove Pavilion, PAssion WaVe and Play Pavilion.",
    ...
    FacilitiesAllotment: "Registration for the allotment plots at the Jurong Lake Gardens has been closed and all plots have been allocated. The current tenure for the Allotment Gardens at Jurong Lake Gardens will end in late April 2022. Online registration of Allotment Gardens will re-open when plots become available (i.e. new Allotment Gardens, withdrawal by existing gardeners etc.). Please check www.nparks.gov.sg/gardening/allotment-gardens for the latest updates on available Allotment Gardens lots and details on registration procedures.",
    ...
    PlantRemoving: "Damaging or removing plants or parts of plants are not permitted. Under the Parks and Trees Act, it is an offence to cut, collect or displace and plant in the Gardens. Offenders can be fined up to $5,000. ",
    ...
    WildlifeSnake: "Do stay calm and back away slowly if you encounter a snake. Do observe the snake from afar. Do keep you dog on a tight leash. Do not try to handle the snake. For assistance with wildlife-related matters, please call NParks Animal Response Centre Helpline: 1800-476-1600 (to see if we can include the images shown in the handbook)",
    WildlifeMonkey: "Do keep food out of sight. Do not carry plastic bags. Do not feed the monkeys. One can be fined up to $5,000. Do not use flash photography. Do not approach the monkeys. For assistance with wildlife-related matters, please call NParks Animal Response Centre Helpline: 1800-476-1600",
    WildlifeOtter: "Do not touch or chase after the otters. Observe them from afar. Do not talk loudly and refrain from using flash photography. Do not attempt to feed the otters. Do not litter or leave sharp objects in the waters. Do keep your dog on a tight leash. For assistance with wildlife-related matters, please call NParks Animal Response Centre Helpline: 1800-476-1600",
    WildlifePhotography: "Do observe the wildlife from afar. Do not talk loudly and avoid using flash photography. Do not trample on the plants in order to capture a good image. Do not use food as bait. For assistance with wildlife-related matters, please call NParks Animal Response Centre Helpline: 1800-476-1600",
    WildlifeBird: "If the bird is a hatchling or nestling, leave it where it was. The parents may return to it. If the bird is a fledgling, find a safe spot for the bird to be. A fledgling is learning to be independent. If possible, always don gloves and a facemask when handling wildlife. For assistance with wildlife-related matters, please call NParks Animal Response Centre Helpline: 1800-476-1600",
    ...
    AVSafety: "AVs are operated by trained and authorised personnel. An operator will be on board the AV at all times. Should there be a need to take immediate control of the AV, the operator will do so. The AV will move at 6km/h on average, similar to brisk walking speed. The AV will emit a sound that is similar to tram bells to alert pedestrians if they veer into the path of the AV. The AV is also designed to stop if it detects obstacles or pedestrians in its path. ",
    ...
    BuggyInfo: "The buggies at Jurong Lake Gardens are mainly used by staff for operational duties including horticulture, housekeeping and security works. They are not available for use or rental by visitors. Wheelchairs are available for loan from the Information Counter (open daily 8.30am to 6.30pm) at the Entrance Pavillion, for elderly or visitors who experience mobility challenges. These can be loaned free-of-charge, on a first-come-first-served basis. Alternatively, you may consider using our Autonomous Vehicle which is operating on Monday to Thursday, 10am to 12pm and 1pm to 4pm if you need help in moving around the gardens. For more information on the AV, you may refer to our website: https://www.nparks.gov.sg/juronglakegardens/who-we-are/jurong-lake-gardens "
  };
